...
export const en: Dictionary = {
  ...
  lobby: {
    ...
    phraseScoringComplete: 'Complete the phrase',
    phraseScoringWord: 'Per word typed',
    phraseScoringMiss: (sends: number) => `Per failed phrase (up to ${sends} sends)`,
    phraseScoringPosition: 'First to complete',
    phraseScoringUncovered: 'Not completed, by share uncovered',
    phraseScoringUncoveredValue: (max: number) => `up to +${max}`,
    phraseLetterTimeNote:
      'Every occurrence of a new letter adds 2 s. When someone completes the phrase, everyone else loses 5 s. No hint in this game.',
    hintOff: 'no hint',
